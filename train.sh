...
# 先24 Batch收敛到0.15左右, 然后降Batch训练, 如果24 Batch训练到底会过拟合
python train.py --cfg configs/s.yml --dataset ../Dataset --epochs 100 --output ../model --base_lr 0.05 --batch_size 24 --log_dir /root/tf-logs
