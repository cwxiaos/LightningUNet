...
python inference.py --output ../prediction --batch 24 --model /root/autodl-tmp/model/best.pth --cfg configs/s.yml --data /root/autodl-tmp/Dataset701_AbdomenCT/imagesVal/FLARETs_0014_0000.nii.gz
